...
/**
 * Default implementation of {@link Pipeline}, resolving requests for {@code SimpleLock} and {@code TimeoutLock}
 ...
 * @since 1.3.0
 */
public final class DefaultPipeline extends Pipeline {

    private static final Logger logger = Logger.getLogger(DefaultPipeline.class.getName());

    public DefaultPipeline(AbstractLockResolver resolver) {
        super(resolver);
    }
    ...
    /**
     * Directly puts lock request metadata into pipelines.
     *
     * @param key      lock key
